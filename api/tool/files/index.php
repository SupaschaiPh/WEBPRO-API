...
$CONFIG = '{"lang":"th","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"light"}';
...
$auth_users = array(
    CONFIG["ADMIN_USER_NAME"] => password_hash(CONFIG["ADMIN_PASSWORD"],PASSWORD_DEFAULT),
    CONFIG["USER_NAME"] => password_hash(CONFIG["USER_PASSWORD"],PASSWORD_DEFAULT)
